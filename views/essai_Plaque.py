...
def show(supabase):
    ...
    if editing_item:
        ...
        # Remplissage automatique forcé du composant avec l'utilisateur courant
        st.session_state["plaque_tech"] = current_user
    ...
    with col3:
        ...
        technicien = st.text_input(
            "Technicien LPEE", value=default_tech, key="plaque_tech"
        )
